...
from networks.layers.basic import Res3D_block, ResTime_block, ResTime_block_v2, ResTime_block_DG, ResTime_block_DD
...
class generator(nn.Module):
    def __init__(self, num_classes, seqlen=100, out_len=100):
        ...
        # self.conv_in = nn.Sequential(DifferenceConv(in_channels=1, out_channels=8, kernel_size=(5,1,1), stride=(1,1,1), padding=(2,0,0)),
        #                              nn.BatchNorm3d(8), nn.ReLU(inplace=True),
        #                              GradientConv(in_channels=8, out_channels=8, kernel_size=(1,7,7), stride=(1,1,1), padding=(0,3,3)),
        #                              nn.BatchNorm3d(8), nn.ReLU(inplace=True))
        ...
        self.conv_in = nn.Sequential(GradientConv(in_channels=1, out_channels=8, kernel_size=(5,7,7), stride=(1,1,1), padding=(2,3,3)),
                                     nn.BatchNorm3d(8), nn.ReLU(inplace=True))
        # self.conv_in = nn.Sequential(nn.Conv3d(in_channels=1, out_channels=8, kernel_size=(5,7,7), stride=(1,1,1), padding=(2,3,3)),
        #                              nn.BatchNorm3d(8), nn.ReLU(inplace=True))
        # self.layer1 = nn.Sequential(Res3D_block(8, 16), ResTime_block_DG(16, 32), Res3D_block(32, 32))
        # self.layer1 = nn.Sequential(ResTime_block_DG(8, 16), ResTime_block_DG(16, 32), ResTime_block_DG(32, 32))
        self.layer1 = nn.Sequential(ResTime_block_DG(8, 16), ResTime_block_DG(16, 32))
        # self.layer1 = nn.Sequential(ResTime_block_v2(8, 16), ResTime_block_v2(16, 32))  # , ResTime_block_v2(32, 32)
        # self.layer1 = nn.Sequential(ResTime_block(8, 16), ResTime_block(16, 32))  # , ResTime_block(32, 32)
        # self.layer1 = nn.Sequential(Res3D_block(8, 16), Res3D_block(16, 32))  # , Res3D_block(32, 32)
        # self.layer1 = nn.Sequential(ResSpace_block_v2(8, 16), ResSpace_block_v2(16, 32))  # , ResSpace_block_v2(32, 32)
        # self.layer1 = nn.Sequential(ResSpace_block(8, 16), ResSpace_block(16, 32))  # , ResSpace_block(32, 32)
        self.TATT = MultiheadTimeAttention_v1(d_model=32, num_head=8, seqlen=seqlen, out_len=out_len)
        # self.conv_out0 = nn.Sequential(nn.Conv3d(in_channels=64, out_channels=32, kernel_size=(1,1,1), stride=(1,1,1), padding=(0,0,0)),
